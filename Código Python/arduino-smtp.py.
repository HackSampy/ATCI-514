...
ASUNTO  = ' ¡ ATCI514. ! '
MENSAJE = ' ¡ Hay una posible inundación. ! '
 
arduino = serial.Serial('COM3', 9600, timeout = 3.0)    #El puerto se abre inmediatamente en la creación de objetos, cuando se da un puerto.
...
def enviar_correo_electronico():
    ...
    smtpserver.close()                                  #Cerramos la conexión con el SMTP server de Goo
